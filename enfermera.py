class enfermera:
    def __init__(self, id, nombre, apellido, fecha, genero, user_name, user_pass, tel, rol):
        self.id = id
        self.nombre = nombre
    ...
    def actualizar_datos(self, nombre, apellido, fecha, genero, user_name, user_pass, tel, rol ):
        self.id = id
        self.nombre = nombre
        self.apellido = apellido
        self.fecha = fecha 
